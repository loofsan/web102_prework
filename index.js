...
function addGamesToPage(games) {
  ...
  for (let i = 0; i < games.length; i++) {
    ...
    gamesList.classList.add("game-card");
...
raisedCard.innerHTML = `<p>$${totalMoney.toLocaleString("en-US")}</p>`;
...
function filterUnfundedOnly() {
  ...
  let listOfFilteredGames = GAMES_JSON.filter((game) => {
...
${totalUnfundedGames} ${
  totalUnfundedGames > 1 ? "games" : "game"
} remain unfunded. We need your help to fund these amazing games.`;

// create a new DOM element containing the template string and append it to the description container
const newElemnent = document.createElement("p");
newElemnent.innerHTML = `
${displayStr}
`;
descriptionContainer.append(newElemnent);
/************************************************************************************
...
document.getElementById("searchKey").addEventListener("input", filterOnSearch);
